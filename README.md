...
proxy-groups:
  ...
  - name: 微软Bing
    ...
    proxies:
      ...
      - 🇵🇱 波兰节点
      - 👻 其他节点
    icon: https://github.com/shindgewongxj/WHATSINStash/raw/main/icon/bing.png
  - name: 微软云盘
    type: select
    proxies:
      - 节点选择
  ...
  - name: 网易音乐
    ...
    proxies:
      ...
      - 节点选择
      - 自动选择
    icon: https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Music_Enhance.png
  - name: 全球直连
    type: select
    proxies:
      - DIRECT
  ...
  - name: 🇺🇲 美国节点
    ...
    interval: 300
    tolerance: 150
    filter: "(?i)美|🇺🇸|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉拉|西雅图|芝加哥|US|CA|United States"
  ...
  - name: 🇵🇱 波兰节点
    ...
    interval: 300
    tolerance: 50
    filter: “(?i)PL|🇵🇱|波兰|波兰节点|华沙|Warsaw|克拉科夫|Krakow|弗罗茨瓦夫|Wroclaw|格但斯克|Gdansk|波兹南|Poznan|卢布林|Lublin”
  ...
  - name: 👻 其他节点
    ...
    interval: 300
    tolerance: 50
    filter: "^(?!.*(香港|HK|美国|US|日本|JP|狮城|新加坡|SG|韩国|KR|台湾|TW|波兰|PL|距离|www|频道|套餐|周|订阅|关注|反代|节点|网址|官网|加入|永久)).*$"
    icon: https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Luffy.png
rules:
  # WebRTC 相关规则
  ...
  - DOMAIN-SUFFIX,dns.sb,节点选择
  - DOMAIN-SUFFIX,twnic.tw,节点选择
  - DOMAIN-SUFFIX,ipleak.net,节点选择
  - DOMAIN-SUFFIX,browserleaks.com,节点选择
  - DOMAIN-SUFFIX,dnsleak.com,节点选择
  ...
  - IP-CIDR,223.87.177.120/32,应用净化,no-resolve
  ...
  - IP-CIDR,205.120.175.0/24,苹果服务,no-resolve
  ...
  - DOMAIN-SUFFIX,telesco.pe,电报吹水
  - IP-CIDR,91.108.0.0/16,电报吹水,no-resolve
  - IP-CIDR,109.239.140.0/24,电报吹水,no-resolve
  - IP-CIDR,149.154.160.0/20,电报吹水,no-resolve
  ...
  - DOMAIN-SUFFIX,spotify.net,Spotify
  ...
  - DOMAIN-SUFFIX,spotifynewsroom.com,Spotify
...
# Claude API & Web Services
  - DOMAIN-SUFFIX,anthropic.com,OpenAi
  - DOMAIN-SUFFIX,claude.ai,OpenAi
  - DOMAIN,api.anthropic.com,OpenAi
  - DOMAIN,docs.anthropic.com,OpenAi
  - DOMAIN,chat.anthropic.com,OpenAi
  - DOMAIN,console.anthropic.com,OpenAi
  - DOMAIN,support.anthropic.com,OpenAi
  # WebSocket connections
  - DOMAIN-SUFFIX,ws.claude.ai,OpenAi
  # Related Services
  ...
  - DOMAIN-SUFFIX,ads-twitter.com,马斯克的废话
  ...
  - DOMAIN-SUFFIX,berlintwitterwall.com,马斯克的废话
